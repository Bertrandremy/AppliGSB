<?php 
/**
 *Vue d'affichage de la liste des visiteurs et des mois dans une liste d�roulante
...
?>
 ...
 <--Affichage de la liste des mois disponibles pour le visiteur choisi dans une liste d&eacute;roulante -->      	
      	<div class="corpsForm">
