<?php 
/**
 * Vue d'affichage de la liste des visiteurs dans une liste d�roulante
...
<div id="contenu">
      ...
      <p>
<--Affichage de la liste des mois disponibles pour le visiteur choisi dans une liste d�roulante -->      
